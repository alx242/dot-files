...
;;
;; If you like flymake but don't like using the mouse to see the error
;; info try this extension (written by a colleague of mine, Rohan
;; Nicholls). Chuck it in your load path and add something like the
;; example below to your .emacs:
;;
